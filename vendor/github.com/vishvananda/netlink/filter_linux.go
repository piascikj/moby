...
// NOTE: this is in filter_linux because it refers to nl.TcPolice which id:919 gh:920
//       is defined in nl/tc_linux.go
type Fw struct {
	FilterAttrs
	ClassId uint32
	// TODO remove nl type from interface id:785 gh:786
	Police nl.TcPolice
	InDev  string
	// TODO Action id:583 gh:584
	Mask   uint32
	AvRate uint32
	Rtab   [256]uint32
	Ptab   [256]uint32
