...
func (m *Manager) Stop(ctx context.Context, clearData bool) {
	...
	defer timer.Stop()
	// TODO: we're not waiting on ctx because it very well could be passed from Run, id:471 gh:472
...
func (m *Manager) becomeLeader(ctx context.Context) {
	...
	// TODO (stevvooe): Allocate a context that can be used to id:345 gh:346
	...
	if err != nil {
		...
		// TODO (stevvooe): It doesn't seem correct here to fail id:441 gh:442
	...
	// TODO (aluzzardi): This should have some kind of error handling so that id:871 gh:872
